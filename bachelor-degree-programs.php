         ...
         <section>
            <div class="featured-hero">
              <div class="img-content">
                ...
                <span>Comprehensive training for ministry excellence.</span>
              </div>
            </div>
        </section>
        <!--Main Slider  end-->
        ...
        <div class="abouttop">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h2 class="featured-heading-text1">Bachelor Degree Programs </h2>
                        ...
                        <!--</p>-->
                        <br>
                        <h2 class="featured-heading-text2" style="font-weight: 550;">Bachelor of Theology (BTh):</h2>
                        <p class="featured-heading-textp">
                            <b>Purpose:</b> Foundational theological training. <br>
                            <b>Expectations:</b> Core understanding of theological principles. <br>
                            <b>Uniqueness:</b> Theoretical focus on theology. <br>
                            <b>Designed for:</b> Individuals pursuing a solid theological foundation for various roles in the church
                            or related fields
                        </p>
                        <br> <hr>
                        <h2 class="featured-heading-text2" style="font-weight: 550;">Bachelor of Ministry (BMin):</h2>
                        <p class="featured-heading-textp">
                            <b>Purpose:</b> Practical training for Christian service. <br>
                            <b>Expectations:</b> Skills for diverse ministry roles.<br>
                            <b>Uniqueness:</b> Emphasizes practical aspects of ministry.<br>
                            <b>Designed for:</b> Those aspiring to engage directly in ministry, community development, or
                            advocacy.
                        </p>
                        <br> <hr>
                        <h2 class="featured-heading-text2" style="font-weight: 550;">Bachelor of Divinity (BDiv):</h2>
                        <p class="featured-heading-textp">
                            <b>Purpose:</b> Integrates both theology and ministry training.<br>
                            <b>Expectations:</b> Comprehensive understanding and skills for ministry leadership.<br>
                            <b>Uniqueness:</b> Balances theological concepts and preparation for practical ministry.<br>
                            <b>Designed for:</b> Individuals preparing for leadership roles in church, community, or Christian
                            organizations.
                        </p>
                    </div>
