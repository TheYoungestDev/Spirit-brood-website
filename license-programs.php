         ...
         <section>
            <div class="featured-hero">
              <div class="img-content">
                ...
                <span>Professional licensing for specialized ministry roles.</span>
              </div>
            </div>
        </section>
        <!--Main Slider  end-->
        ...
        <div class="abouttop">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h2 class="featured-heading-text1">License Programs </h2>
                        ...
                        <p class="featured-heading-textp">
                            <b>Purpose:</b> Expand on Certificate Programs with additional practicum hours for practical
                            experience. <br> <br>
                            <b>Expectations</b>: Enhanced practical skills alongside theoretical knowledge. <br> <br>
                            <b> Uniqueness:</b> Longer duration, emphasizes hands-on experience. <br> <br>
                            <b>Designed for:</b> Professionals aiming for a deeper understanding and practical application of faith in their fields.
