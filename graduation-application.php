<?php $IPATH = $_SERVER["DOCUMENT_ROOT"]."/assets/php/";
        ...
        <div class="abouttop">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h2 class="featured-heading-text1">Graduation Application</h2>
                        <!-- <h3 class="featured-heading-text2">Spirit Brood Seminary Honors Life Experience.</h3> -->
                        <p class="featured-heading-textp">Are you done with your coursework and thesis?
                            That is indeed a significant achievement, and we are thrilled to support
                             you as you take the final step toward graduation. Congratulations 
                             on nearing the completion of your program at Spirit Brood Theological Seminary! <br><br>

                             To begin the graduation process, please complete and submit the application 
                             form below. Once submitted, our administrative team will conduct a final 
                             evaluation to confirm that all requirements have been met. After this review,
                             your application will be recommended to the board for graduation approval.<br><br>
                             We’re excited to celebrate your accomplishments and look forward to
                             welcoming you to our community of Spirit Brood alumni!
                            <br><br></p>

                            
                            <form action="graduation-processing.php" method="POST">
    <div class="row">
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label for="submission-link">Link to Submission Portal</label>
                <input type="url" class="form-control" placeholder="Enter submission portal link" name="submission_link" required>
            </div>
        </div>
    </div>
