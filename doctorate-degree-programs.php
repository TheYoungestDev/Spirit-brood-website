         ...
         <section>
            <div class="featured-hero">
              <div class="img-content">
                ...
                <span>Innovative academic research and ministerial leadership.</span>
              </div>
            </div>
        </section>
        <!--Main Slider  end-->
        ...
        <div class="abouttop">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h2 class="featured-heading-text1">Doctorate Degree Programs </h2>
                        <!--<p class="featured-heading-textp">During your degree, you'll acquire essential skills applicable across various professions, including communication, critical thinking, and cultural studies. These foundational competencies will support your success in both your career and further studies.-->
                        <!--</p>-->
                        <br>
                        <h2 class="featured-heading-text2" style="font-weight: 550;">Doctorate  of Theology (ThD):</h2>
                        <p class="featured-heading-textp">
                            <b>Purpose:</b> Advanced scholarship and research in theology. <br>
                            <b>Expectations:</b> Contribution to theological knowledge through original research.  <br>
                            <b>Uniqueness:</b> Highest level of theoretical depth. <br>
                            <b>Designed for:</b> Those pursuing a career in academia or theological research.
                        </p>
                        <br> <hr>
                        <h2 class="featured-heading-text2" style="font-weight: 550;">Doctorate of Ministry (DMin):</h2>
                        <p class="featured-heading-textp">
                            <b>Purpose:</b> Advanced practical competence in ministry. <br>
                            <b>Expectations:</b> Leadership in ministry with practical impact. <br>
                            <b>Uniqueness: </b> Emphasis on applied knowledge and skills. <br>
                            <b>Designed for:</b> Experienced ministry leaders aiming for advanced roles.
                        </p>
                        <br> <hr>
                        <h2 class="featured-heading-text2" style="font-weight: 550;">Doctorate of Divinity (DDiv):</h2>
                        <p class="featured-heading-textp">
                            <b>Purpose:</b> Integrates advanced scholarship and practical competence. <br>
                                <b> Expectations:</b> Leadership roles with a holistic understanding of theology and ministry. <br>
                            <b>Uniqueness:</b> Uniquely multidisciplinary, bridging theory and application. <br>
                            <b>Designed for:</b> Visionary leaders for core positions in church, ministry, or broader settings.
                        </p>
                    </div>
