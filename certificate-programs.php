         ...
         <section>
            <div class="featured-hero">
              <div class="img-content">
                ...
                <span>Foundational skills for effective Christian service.</span>
        ...
        <div class="abouttop">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h2 class="featured-heading-text1">Certificate Programs </h2>
                        ...
                        <p class="featured-heading-textp">
                           <b>Purpose:</b> Foundational training for professionals to integrate faith into their professional fields
                            through proficiency in Christian Counseling, Mediation, Administration, Caregiving, Philosophy,
                            and Corporate Chaplaincy. <br> <br>
                           <b>Expectations:</b> Fundamental understanding of faith integration in respective fields. <br><br>
                        <b>Uniqueness:</b> Entry-level, short duration courses, focused on practical knowledge, skill, and
                            proficiency. <br> <br>
                           <b> Designed for: </b>Working professionals who desire to integrate faith and ministry in their secular
                            professions.
